  ...
  const handleSaveDriver = async () => {
    ...
    try {
      if (editDriverId) {
        ...
        // Add new driver - PIN is auto-generated by the server if not provided
        const res = await fetch('/api/drivers', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            ...
            email: driverEmail,
            phone: driverPhone,
            pin: driverPin || undefined, // Server auto-generates if not provided
        ...
        // Show the auto-generated PIN to the coordinator so they can share it with the driver
